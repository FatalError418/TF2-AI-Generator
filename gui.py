...
text_weapon_idea_tooltip = Tooltip(text_weapon_idea, "What should the weapon be about? The weapon idea which will be fed to the AI and if a weapon idea is provided it will try to generate a weapon based on it. For example: 'A flamethrower for the pyro which replaces the air blast with a fireball, with the negative of having less fire damage resistance.'")
